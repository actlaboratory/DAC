...
４，出力先を選択します。
５，音声エンジンを選択します。
６，設定ボタンから、各音声エンジンごとの設定を行います。これには、声質などの設定が含まれます。
７，開始ボタンを押し、完了するまで待ちます。

なお、音声エンジンにVoicevoxを用いる場合、事前にVoicevoxの起動が完了している必要があります。
音声エンジンの設定と変換処理を行っている間は、起動させたままにする必要があります。
また、Voicevoxを用いた変換処理にはかなりの時間がかかります。
...
４．2．１．１．2　一時フォルダの場所
変換処理を行うための一時的な作業スペースを作成する場所を指定します。
